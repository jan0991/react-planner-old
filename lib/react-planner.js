...
var ReactPlanner = function (_Component) {
  ...
  _createClass(ReactPlanner, [{
    ...
    value: function componentWillMount() {
      ...
      store.dispatch((0, _projectActions.loadProject)(apiData));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(Toolbar, _extends({ saveFunc: this.props.saveFunc, width: toolbarW, height: toolbarH, state: extractedState }, props)),
